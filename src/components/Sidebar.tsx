        ...
        {open && (
          ...
          >
            ...
            <div onClick={() => isMobile() && setOpen(false)}>
              <Badge href='/events' text='Go to Next Event' />
            </div>
          </motion.div>
        )}
      </AnimatePresence>
  ...
  return (
    <div className='flex space-x-2'>
      ...
      <div className='flex text-sm flex-col'>
        <p className='font-bold text-primary'>DatadogKRUG</p>
        <p className='font-light text-secondary'>Datadog Korea User Group</p>
      </div>
    </div>
  );
};
